$(function(){$('[data-toggle="tooltip"]').tooltip()});function insertDiv(){let e=document.createElement("div");e.id="form-container",e.style.display="none",e.innerHTML=`
        ...
        <form id="urlForm">
            ...
            <input class="btn-primary mb-1" type="submit" value="Generate URL"><br>
    ...
    `;let t=document.createElement("div");t.id="content-container",t.style.display="none",t.innerHTML=`
